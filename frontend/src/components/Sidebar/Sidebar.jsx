...
const Sidebar = () => {
  ...
  return (
    <aside
      id="sidebar"
      className={`rounded-md mt-2 mb-1 flex flex-col min-h-screen shadow-md shadow-slate-500 transition-all duration-300 z-10 bg-gradient-to-br from-white to-slate-50 dark:from-gray-800 dark:to-gray-700 ${
        collapsed ? "lg:w-16 w-64" : "w-64" // Always full-width on mobile, collapsible on desktop
      }`}
    >
